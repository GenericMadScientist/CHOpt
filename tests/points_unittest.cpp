...
TEST_CASE("Hold notes")
{
    SECTION("Hold note points depend on resolution")
    {
        ...
        TimeConverter converter {{}, 192, ChEngine(), {}};
        PointSet first_points {track, converter,   {},
                               1.0,   Second(0.0), ChEngine()};
        ...
        TimeConverter second_converter {{}, 200, ChEngine(), {}};
        PointSet second_points {second_track, second_converter, {},
                                1.0,          Second(0.0),      ChEngine()};
    ...
    SECTION("Resolutions below 25 do not enter an infinite loop")
    {
        ...
        TimeConverter converter {{}, 1, ChEngine(), {}};
        PointSet points {track, converter, {}, 1.0, Second(0.0), ChEngine()};
...
TEST_CASE("End of SP phrase points")
{
    ...
    TimeConverter converter {{}, 192, ChEngine(), {}};
    PointSet points {track, converter, {}, 1.0, Second(0.0), ChEngine()};
    PointSet unison_points {track, converter,   {{1100, 53}},
                            1.0,   Second(0.0), Rb3Engine()};
    ...
    REQUIRE(!std::next(points.cbegin(), 2)->is_unison_sp_granting_note);

    REQUIRE(!unison_points.cbegin()->is_unison_sp_granting_note);
    REQUIRE(std::next(unison_points.cbegin(), 2)->is_unison_sp_granting_note);
}
...
TEST_CASE("hit_window_start and hit_window_end are set correctly")
{
    TimeConverter converter {
        {{}, {{0, 150000}, {768, 200000}}}, 192, ChEngine(), {}};
    ...
    SECTION("Squeeze setting is accounted for")
    {
        ...
        NoteTrack<NoteColour> track {notes, {}, {}, {}, {}, 192};
        PointSet points {track, converter, {}, 0.5, Second(0.0), ChEngine()};
    ...
    SECTION("Restricted back end is taken account of")
    {
        ...
        NoteTrack<NoteColour> track {notes, {}, {}, {}, {}, 192};
        PointSet points {track, converter, {}, 1.0, Second(0.0), RbEngine()};
        PointSet fifty_sqz_points {track, converter,   {},
                                   0.5,   Second(0.0), RbEngine()};
...
TEST_CASE("RB bass multiplier is taken into account")
{
    ...
    const PointSet points {track, converter,   {},
                           1.0,   Second(0.0), RbBassEngine()};
...
TEST_CASE("Video lag is taken into account")
{
    ...
    SECTION("Tick points are not multiplied prematurely")
    {
        ...
        PointSet points {other_track, converter,     {},
                         1.0,         Second(-0.40), ChEngine()};
...
{
    std::vector<Note<DrumNoteColour>> notes {{0}, {192}, {384}};
    std::vector<DrumFill> fills {{380, 385}};
